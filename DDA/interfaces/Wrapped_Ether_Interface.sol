...
// @audit - Interface for a Wrapped Ether Interface
interface Wrapped_Ether_Interface {
  // @audit - A getter for the total supply of a WrappedEther contract 
  // @returns - uint: The total supply of the WrappedEther
